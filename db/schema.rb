...
ActiveRecord::Schema.define(version: 20160807081826) do
  ...
  create_table "orders", force: true do |t|
    ...
    t.text     "service_copy"
    t.string   "dot_number"
    t.string   "product_sample"
    t.string   "to_be_completed_by"
  ...
  create_table "report_expense_images", force: true do |t|
    t.integer  "report_id"
    t.string   "file"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "report_table_images", force: true do |t|
    t.integer  "report_id"
    t.string   "file"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "services", force: true do |t|
    ...
    t.boolean  "no_need_second_date",   default: false
  end
